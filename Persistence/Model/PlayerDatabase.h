...
class PlayerDatabase : public Database
{
  ...
  public:
    ...
    std::string LookupPlayerByProvider(const std::string &provider,
                                       const std::string &providerId);
    std::string GetProviderIdByPlayerId(const std::string &playerId,
                                        const std::string &provider);
    void        UpsertProviderMap(const std::string &provider,
                                  const std::string &providerId,
